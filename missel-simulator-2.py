# missile_simulator_streamlit.py
...
class Missile:
    ...
    def simulate_trajectory(self):
        ...
        max_height = (vy ** 2) / (2 * g)
        calculated_range = (self.speed ** 2 * math.sin(2 * angle_rad)) / g
        ...
        if abs(calculated_range - self.target_distance) > self.target_distance * 0.1:
